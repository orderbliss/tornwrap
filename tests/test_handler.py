...
class ContentTypeHandler(RequestHandler):
    def get(self):
...
class TestContentType(AsyncHTTPTestCase):
    def get_app(self):
        return Application([(r'/', ContentTypeHandler)], log_function=logger.handler)
...
class ErrorNoRollbarHandler(RequestHandler):
    def get(self):
...
class TestErrorNoRollbar(AsyncHTTPTestCase):
    def get_app(self):
        return Application([(r'/', ErrorNoRollbarHandler)])
